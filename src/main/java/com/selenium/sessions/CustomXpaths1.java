...
public class CustomXpaths1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// driver.findElement(By.xpath("//span[text()='test1
		// testing']//ancestor::td//preceding-sibling::td//input[@type='checkbox']/..")).click();
		// Thread.sleep(3000);
	...
	public static void selectCheckboxUsingPrecedtagingByXpath(WebDriver driver, String value) {
		driver.findElement(By.xpath(
				"//span[text()='" + value + "']//ancestor::td//preceding-sibling::td//input[@type='checkbox']/.."))
				.click();
	}

	public static void getTestUsingFollowingTagByXpath(WebDriver driver, String value) {
		String text = driver.findElement(By.xpath("//span[text()='" + value + "']//ancestor::td//following-sibling::td//following-sibling::td/span"))
				.getText();
